...
# Add WhiteNoise static storage (Django 4.2 style):
STORAGES = {
    "staticfiles": {
...
ALLOWED_HOSTS = ['roundtrip.cs.nor.ou.edu', '127.0.0.1']
# ALLOWED_HOSTS = ['roundtrip.cs.nor.ou.edu']
...
MIDDLEWARE = [
    ...
    'mysite.middleware.MentorRedirectMiddleware', 
]
...
EMAIL_PORT = 587               # Use port 587 for TLS (secure connection)
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') #This is for the real server
MEDIA_URL = '/media/' #This is for the real server
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') #This is for the real server
